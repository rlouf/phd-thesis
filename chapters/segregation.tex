...
\begin{figure}
    \centering
    %\includegraphics[width=0.99\textwidth]{./figures/figure2.png}
...
\begin{figure} 
    ...
    \caption{Distribution of the value of the clustering coefficient for
...
\begin{figure} 
    ...
    \caption{Distribution of the ratio of the size of the
