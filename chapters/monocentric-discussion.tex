...
of transportation in the US, as shown of Figure~\ref{fig:transportation_mode}. The
...
We show an example of such situation on Figure~\ref{fig:hotspots_boston}. We use
...
Figure~\ref{fig:concentration_loubar} the ratio of the total number of individuals
...
3D plot shown on Figure~\ref{density_3d} should convince the reader that the world
