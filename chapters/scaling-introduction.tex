...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{gfx/chapter-scaling/scaling_scheme.pdf}
    \caption{Example of a linear (black), sublinear (blue) and superlinear (red)
    behaviour.\label{fig:scaling_scheme}}
\end{figure}
