...
\part{Polycentricity} % Second part of the thesis
\label{part:polycentricity}

\include{chapters/monocentric} % Chapter 2
\include{chapters/congestion} % Chapter 2
...
\part{Segregation} % Second part of the thesis
\label{part:stratification}

\include{chapters/segregation-introduction} % Chapter 2
\include{chapters/segregation} % Chapter 2
...
\include{chapters/conclusion} % Chapter 2
